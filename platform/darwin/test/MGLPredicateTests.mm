...
- (void)testComparisonPredicates {
    ...
    }
    {
        ...
        XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
        NSPredicate *predicateAfter = [NSPredicate predicateWithFormat:@"NOT MGL_MATCH(CAST(x, 'NSNumber'), { 6, 5, 4, 3 }, YES, NO) == YES"];
        auto forwardFilter = [NSPredicate predicateWithMGLJSONObject:expected].mgl_filter;
        NSPredicate *forwardPredicateAfter = [NSPredicate mgl_predicateWithFilter:forwardFilter];
        XCTAssertEqualObjects(predicateAfter, forwardPredicateAfter);
    }
    {
        NSArray *expected = @[@"match", @[@"get", @"a"], @[@"literal", @[@"b", @"c"]], @YES, @NO];
    ...
    {
        NSArray *expected = @[@"match", @[@"geometry-type"], @[@"literal", @[@"LineString", @"Polygon"]], @YES, @NO];
    ...
    }
    {
        ...
        XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
        NSPredicate *predicateAfter = [NSPredicate predicateWithFormat:@"MGL_MATCH(CAST(x, 'NSNumber'), { 6, 5, 4, 3 }, YES, NO) == YES"];
        auto forwardFilter = [NSPredicate predicateWithMGLJSONObject:expected].mgl_filter;
        NSPredicate *forwardPredicateAfter = [NSPredicate mgl_predicateWithFilter:forwardFilter];
        XCTAssertEqualObjects(predicateAfter, forwardPredicateAfter);
    }
